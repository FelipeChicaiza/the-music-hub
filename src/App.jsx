  ...
  import CatChart from "./components/CatCharts";
          ...
          <div className="master">
            ...
            <div className="hero">
              ...
              <div className="charts">
                  <h3>Average Energy Level by Grooming Level</h3>
                  {list && <CatChart list={list} />}
              </div>
                        ...
                        <ul>
                          {list.map((element) => (
                            <CatInfo
                              ...
                              image={element["image"]?.url || "https://via.placeholder.com/150"}
                            />
                          ))}
                        </ul>
                      </>
